...
public class PointTests {
  ...
  public void testDistance2() {
    ...
    Assert.assertEquals(Point.distance(p3, p4), 25.079872407968907);
  }
  ...
  public void testDistance3() {
    ...
    Assert.assertEquals(Point.distance(p5, p6), 369.2289262774519);
  }
  ...
  public void testDistance4() {
    ...
    Assert.assertEquals(Point.distance(p7, p8), 18.445595680270124);
